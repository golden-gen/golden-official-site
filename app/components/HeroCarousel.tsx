  ...
  const slides = [
    {
        ...
        subtitle: "Participate in the ongoing GGQuiz 2024 and showcase your knowledge.",
        tagline: "Be part of the challenge!",
        actionText: "Register Now",
        actionLink: "/ggquiz-2024",
      },
    {
      title: "Every Home Deserves a Golden Child",
      subtitle: "Welcome to the official website of Golden Generation Community Development Club (GGCDC).",
    ...
    },
    {
      ...
      subtitle: "Help us create a brighter future with your generous donations.",
